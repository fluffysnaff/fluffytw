...
// hacks
// MACRO_CONFIG_INT(variable_name, ingame_name, lowest_number, start_with_number, maximum_number, CFGFLAG_CLIENT | CFGFLAG_SAVE, string_description)
// if you want to have a variable that is visible/acessible only through code remove CFGFLAG_CLIENT
